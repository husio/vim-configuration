...
exec "Snippet jscript <script type=\"text/javascript\" src=\"".st."filepath".et."\"></script><CR>".st.et
exec "Snippet css <link rel=\"stylesheet\" type=\"text/css\" href=\"".st."filepath".et."\" /><CR>".st.et
