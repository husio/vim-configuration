...
hi SpecialKey	ctermfg=61          ctermbg=None       cterm=Bold
hi Directory	ctermfg=57          ctermbg=None       cterm=None
...
hi TabLineSel   ctermfg=105         ctermbg=238         cterm=Bold
hi TabLineFill  ctermfg=246         ctermbg=234         cterm=None
hi Title        ctermfg=99          ctermbg=234         cterm=Bold
